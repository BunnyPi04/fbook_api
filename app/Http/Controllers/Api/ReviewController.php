...
class ReviewController extends ApiController
{
    ...
    public function vote(Request $request, VoteRepository $voteRepository, UserRepository $userRepository, LogReputationRepository $logReputationRepository)
    {
        return $this->doAction(function () use ($request, $voteRepository, $userRepository, $logReputationRepository) {
